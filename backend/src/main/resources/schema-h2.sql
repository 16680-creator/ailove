...
CREATE INDEX IF NOT EXISTS idx_wardrobe_user_cat ON wardrobe_item(user_id, category_code, deleted);
...
CREATE INDEX IF NOT EXISTS idx_outfit_user ON outfit(user_id, create_time);
...
CREATE INDEX IF NOT EXISTS idx_outfit_item_outfit ON outfit_item(outfit_id);
